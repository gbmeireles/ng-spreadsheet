...
})(this, function(__WEBPACK_EXTERNAL_MODULE_0__, __WEBPACK_EXTERNAL_MODULE_17__, __WEBPACK_EXTERNAL_MODULE_145__, __WEBPACK_EXTERNAL_MODULE_146__) {
...
Object.defineProperty(exports, "__esModule", { value: true });
var data_spreadsheet_row_list_getter_1 = __webpack_require__(21);
exports.DataSpreadsheetRowListGetter = data_spreadsheet_row_list_getter_1.DataSpreadsheetRowListGetter;
var column_list_getter_1 = __webpack_require__(104);
...
var title_spreadsheet_row_list_getter_1 = __webpack_require__(29);
exports.TitleSpreadsheetRowListGetter = title_spreadsheet_row_list_getter_1.TitleSpreadsheetRowListGetter;
var column_position_information_map_calculator_1 = __webpack_require__(105);
...
var cell_position_updater_1 = __webpack_require__(102);
exports.CellPositionUpdater = cell_position_updater_1.CellPositionUpdater;
var section_position_information_map_calculator_1 = __webpack_require__(113);
...
var spreadsheet_section_scroll_width_map_calculator_1 = __webpack_require__(115);
...
var cell_getter_1 = __webpack_require__(100);
exports.CellGetter = cell_getter_1.CellGetter;
var filters_1 = __webpack_require__(23);
var column_identifier_map_getter_1 = __webpack_require__(103);
exports.ColumnIdentifierMapGetter = column_identifier_map_getter_1.ColumnIdentifierMapGetter;
var scrollbar_dimensions_getter_1 = __webpack_require__(26);
exports.ScrollbarDimensionsGetter = scrollbar_dimensions_getter_1.ScrollbarDimensionsGetter;
...
exports.SPREADSHEET_SCOPE_PROVIDERS = [
    ...
    scrollbar_dimensions_getter_1.ScrollbarDimensionsGetter,
]);
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(0);
var spreadsheet_constants_1 = __webpack_require__(16);
var ColumnSizeUpdater = (function () {
    ...
    ColumnSizeUpdater.prototype.columnSizeUpdater = function (spreadsheetState, action) {
        return spreadsheetState.columnList.map(function (i) {
            if (i.name === action.payload.columnName) {
                return Object.assign({}, i, {
                    width: Math.max(action.payload.columnSize, spreadsheet_constants_1.MIN_COLUMN_SIZE),
                });
            }
            else {
                return Object.assign({}, i);
...
Object.defineProperty(exports, "__esModule", { value: true });
var body_1 = __webpack_require__(31);
...
var DataSpreadsheetRowListGetter = (function () {
    ...
    DataSpreadsheetRowListGetter.prototype.get = function (spreadsheetState, titleRowListCount) {
        var result = spreadsheetState.columnList.length === 0 ? [] : new Array(spreadsheetState.dataRowList.length);
...
var filtered_data_row_list_getter_1 = __webpack_require__(22);
var number_filter_1 = __webpack_require__(10);
var text_filter_1 = __webpack_require__(11);
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(0);
var ScrollbarDimensionsGetter = (function () {
    function ScrollbarDimensionsGetter() {
    }
    ScrollbarDimensionsGetter.prototype.get = function () {
        if (this.dimensions) {
    ...
    return ScrollbarDimensionsGetter;
}());
ScrollbarDimensionsGetter = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [])
], ScrollbarDimensionsGetter);
exports.ScrollbarDimensionsGetter = ScrollbarDimensionsGetter;
...
Object.defineProperty(exports, "__esModule", { value: true });
var core_1 = __webpack_require__(0);
var common_1 = __webpack_require__(145);
var spreadsheet_1 = __webpack_require__(18);
var declarations = [
...
Object.defineProperty(exports, "__esModule", { value: true });
var spreadsheet_event_1 = __webpack_require__(133);
exports.SpreadsheetEvent = spreadsheet_event_1.SpreadsheetEvent;
var editable_component_1 = __webpack_require__(132);
exports.EditableComponent = editable_component_1.EditableComponent;
var viewable_component_1 = __webpack_require__(134);
...
var GoToCellLocationAction = (function () {
    function GoToCellLocationAction(rowIndex, spreadsheetColumnIndex, isToUseMinimunScroll, isNavigation, isToForceFocus) {
        if (isNavigation === void 0) { isNavigation = true; }
        if (isToForceFocus === void 0) { isToForceFocus = false; }
...
Object.defineProperty(exports, "__esModule", { value: true });
var SetIsToShowStatusBarAction = (function () {
    function SetIsToShowStatusBarAction(isToShowStatusBar) {
        this.type = SetIsToShowStatusBarAction.type;
        this.payload = isToShowStatusBar;
    }
    return SetIsToShowStatusBarAction;
}());
SetIsToShowStatusBarAction.type = 'SetIsToShowStatusBar';
exports.SetIsToShowStatusBarAction = SetIsToShowStatusBarAction;
...
(function (ColumnDataTypeEnum) {
    ...
    ColumnDataTypeEnum[ColumnDataTypeEnum["Boolean"] = 3] = "Boolean";
...
var CellLocationRelativeToViewportGetter = (function () {
    function CellLocationRelativeToViewportGetter(spreadsheetState, scrollbarDimensionsGetter) {
        this.spreadsheetState = spreadsheetState;
        this.scrollbarDimensionsGetter = scrollbarDimensionsGetter;
    }
...
CellLocationRelativeToViewportGetter = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [typeof (_a = typeof spreadsheet_state_1.SpreadsheetState !== "undefined" && spreadsheet_state_1.SpreadsheetState) === "function" && _a || Object, typeof (_b = typeof scrollbar_dimensions_getter_1.ScrollbarDimensionsGetter !== "undefined" && scrollbar_dimensions_getter_1.ScrollbarDimensionsGetter) === "function" && _b || Object])
...
var ColumnListGetter = (function () {
    ...
    ColumnListGetter.prototype.get = function (columnDefinitionList) {
        ...
        return columnDefinitionList.filter(function (c) { return !c.isHidden; }).map(function (columnDefinition) {
            ...
            spreadsheetColumn.width = Math.max(spreadsheetColumn.width || spreadsheetColumn.defaultWidth, spreadsheet_constants_1.MIN_COLUMN_SIZE);
...
Object.defineProperty(exports, "__esModule", { value: true });
var comparisson_type_enum_1 = __webpack_require__(24);
...
var ColumnCellComponent = ColumnCellComponent_1 = (function () {
    ...
    ColumnCellComponent.prototype.onDragOver = function (evt) {
        if (!ColumnCellComponent_1.columnToMove) {
            return;
        }
...
__decorate([
    ...
    __metadata("design:type", Boolean)
], ColumnCornerCellComponent.prototype, "isFiltered", void 0);
__decorate([
    core_1.HostBinding('style.width'),
    __metadata("design:type", Object)
...
var ColumnResizeComponent = (function () {
    function ColumnResizeComponent(el, renderer, app, columnTargetWidthGetter, columnSizeUpdater, mousePositionGetter, eventEmitter, cdr) {
        this.el = el;
        this.renderer = renderer;
        this.app = app;
    ...
    ColumnResizeComponent.prototype.onMouseMove = function (evt) {
        ...
        if (newColumnSize >= spreadsheet_constants_1.MIN_COLUMN_SIZE) {
...
var SpreadsheetStore = (function () {
    function SpreadsheetStore(dispatcher, columnListGetter, spreadsheetSectionListGetter, spreadsheetColumnListGetter, columnPositionInformationMapCalculator, spreadsheetSectionScrollWidthMapCalculator, columnViewportUpdater, columnMover, rowViewportUpdater, columnSizeUpdater, sectionPositionInformationMapCalculator, numberTitleRowListGetter, numberDataRowListGetter, columnToRenderIndexListGetter, spreadsheetSectionDataRowMapGetter, numberFilter, filteredDataRowListGetter, cellLocationRelativeToViewportGetter, dataSpreadsheetRowListGetter, titleSpreadsheetRowListGetter) {
        ...
        this.dispatcher.subscribe(function (action) {
            ...
            switch (action.type) {
                ...
                case events_1.SetIsToShowStatusBarAction.type: {
                    _this.spreadsheetState = _this.setIsToShowStatusBar(action);
                    break;
                }
                ...
                case events_1.UpdateSpreadsheetSizeAction.type: {
                    _this.spreadsheetState = _this.updateSpreadsheetSize(action, _this.spreadsheetState);
                    break;
                }
    ...
    SpreadsheetStore.prototype.goToCellLocation = function (action) {
        ...
        var lastRowIndex = spreadsheetState.dataSpreadsheetRowList.reduce(function (pv, cv) { return Math.max(cv.rowIndex, pv); }, 0);
    ...
    SpreadsheetStore.prototype.clearFilter = function (action) {
        ...
        spreadsheetState.numberDataRowList = this.numberDataRowListGetter.get(spreadsheetState);
        var isFilterOpenMap = {};
        Object.keys(spreadsheetState.isFilterOpenMap).forEach(function (columnIndex) {
    ...
    SpreadsheetStore.prototype.updateSpreadsheetSize = function (action, spreadsheetState) {
        var _this = this;
        spreadsheetState = Object.assign({}, spreadsheetState);
        var columnBarHeight = 20;
        ...
        var bodyHeight = Math.max(spreadsheetState.totalHeight - headerHeight - calculatedStatusBarHeight - detailsBarHeight, spreadsheetState.dataRowHeight * 3);
    ...
    SpreadsheetStore.prototype.setIsToShowStatusBar = function (action) {
        var spreadsheetState = Object.assign({}, this.spreadsheetState);
        spreadsheetState.isToShowStatusBar = action.payload;
        var updateSizeAction = new events_1.UpdateSpreadsheetSizeAction(spreadsheetState.totalHeight, spreadsheetState.spreadsheetWidth);
...
var column_cell_1 = __webpack_require__(33);
var column_resize_1 = __webpack_require__(34);
var services_1 = __webpack_require__(3);
var events_1 = __webpack_require__(2);
var spreadsheet_state_1 = __webpack_require__(4);
var spreadsheet_store_1 = __webpack_require__(141);
var rxjs_1 = __webpack_require__(17);
...
var SpreadsheetComponent = (function () {
    ...
    SpreadsheetComponent.prototype.goToRow = function (rowNumber) {
        if (rowNumber >= this.firstDataRowRowNumber) {
            ...
            this.dispatcher.emit(new events_1.GoToCellLocationAction(rowIndex, spreadsheetColumnIndex, false, true, true));
            this.cdr.markForCheck();
        }
    };
    SpreadsheetComponent.prototype.goToRowByRowData = function (rowData) {
        ...
        var spreadsheetColumnIndex = this.spreadsheetState.activeCellLocation.columnIndex;
        var action = new events_1.GoToCellLocationAction(row.rowIndex, spreadsheetColumnIndex, false, true, true);
...
var StatusBarComponent = (function () {
    function StatusBarComponent(cdr, dispatcher) {
        this.cdr = cdr;
        this.dispatcher = dispatcher;
        this.message = '';
    ...
    StatusBarComponent.prototype.ngOnChanges = function (changes) {
        ...
        if (this.message == null || this.message == '') {
            this.isVisible = false;
            this.dispatcher.emit(new events_1.SetIsToShowStatusBarAction(false));
        }
        else {
            this.isVisible = true;
            this.dispatcher.emit(new events_1.SetIsToShowStatusBarAction(true));
        }
...
StatusBarComponent = __decorate([
    ...
    __param(1, core_1.Inject(events_1.DISPATCHER_TOKEN)),
    __metadata("design:paramtypes", [typeof (_a = typeof core_1.ChangeDetectorRef !== "undefined" && core_1.ChangeDetectorRef) === "function" && _a || Object, typeof (_b = typeof core_1.EventEmitter !== "undefined" && core_1.EventEmitter) === "function" && _b || Object])
], StatusBarComponent);
