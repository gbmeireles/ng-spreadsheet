System.register(['@angular/core', '../../../Services/Services', './ColumnRow/ColumnRowComponent', './ColumnResize/ColumnResizeComponent'], function(exports_1) {
    ...
    var core_1, Services_1, ColumnRowComponent_1, ColumnResizeComponent_1;
    var HeaderSectionComponent;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
            ...
            function (ColumnRowComponent_1_1) {
                ColumnRowComponent_1 = ColumnRowComponent_1_1;
            },
            function (ColumnResizeComponent_1_1) {
                ColumnResizeComponent_1 = ColumnResizeComponent_1_1;
            }],
        execute: function() {
            HeaderSectionComponent = (function () {
